		 ...
		 <tr height="10" style="font-family:Verdana; font-size:9px">
	      ...
	      <p>DENCE</p></th>
		   ...
		   <th width="53" rowspan="2" align="center"><p>IN</p><p>HAND</p></th>
			...
			<th width="393" rowspan="2" align="center">Action</th>
		</tr>
		<tr height="30" style="font-family:Verdana; font-size:9px;">
		 ...
		 <?	
			...
			//print_r($cRes);
				...
				$cFres=$obj->fetchrow($cRes);
					if($fres[10]<=$chkDate){
						...
						$rate=$obj->sumfield("empsaldet", "rate", "empCode='$fres[2]' and salYear=$yr and salMonth=$m and payHead='Basic'");	
			...
			<tr height="30" style="font-size:9px;">
				...
				<th style="min-width:inherit; max-width:inherit" align="center"><?= (int)$rate?></th>
				...
				<th width="393" align="center"><input type="button" id="btn" name="btn" value="Regenerate" onclick="navigate('../sOneEdit?ec=<?=$fres[2]?>&mnth=<?=$sm?>&yr=<?=$yr?>&dept=<?=$deptFres[0]?>');" /></th>
			</tr>
			<?
