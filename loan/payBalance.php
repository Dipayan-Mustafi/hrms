...
function checkVch(v){
  ...
  <div class="contDiv">
  <h2>Payment of eligibility amount</h2>
  <div class="divLine" style="text-align:right"><input type="button" value="<< Back" onclick="navigate('index');" /></div>
    <form name="form1" id="form1" method="post" action="rcvBack">
		...
		<div class="DivLine">
			...
			<div class="DivCell" style="width:20%;">Eligible Amount</div>
			<div class="DivCell" style="width:20%;">Rs. <?= sprintf("%0.2f",$elgAmnt);?></div>
		</div>
